...
class CalendarService:
    ...
    Methods:
        ...
        _get_calendar_events(self) : Fetch raw calendar events from URL.
        ...
        get_next_concert_data(self) : Get next concert data from index file.
        _format_email_content(self, summary, date_str, pdf_file) : Format email content.
        mail_me_next_concert(self) : Email next concert details.
    ...
    def __init__(self):
        ...
        self.index_path = Path(cfg.agenda.path_concert) / "concerts.json"
